...
**Brief mode** (default) — optimized for mobile chat. Key facts only, short lines, no section longer than 3 lines. Use this when the user just wants the essentials.

**Full mode** — comprehensive. More context in each section, 2-3 sentences per section. Use this when the user asks for a detailed briefing or "everything."

If the user doesn't specify, use brief mode.
